### All credit and kudos go to the FoundationPress repository, authors, and the great people that contribute there.


This is based on FoudationPress. The main difference is the entire build system is based on **Webpack 4**.

I originally had this on a branch, however it became cumbersome/confusing for me to keep track of the original repo and have different modules etc. for this one. So, I split it out and in good spirit release it open source to anyone who might find it useful.

Currently: Foundation 6.5.1

Every so often I will try and sync it with the original.

**Requires the latest [Node.js](http://nodejs.org) to be installed on your machine.**
...
--------------------------------------Original README updated (05-24-2019)------------------------------------
